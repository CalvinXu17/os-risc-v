...
typedef struct _dmac_channel_config
{
    ...
    uchar ctl_sinc;
    uchar ctl_dinc;
    uchar ctl_src_tr_width;
    uchar ctl_dst_tr_width;
    uchar ctl_ioc_blktfr;
    uchar ctl_src_stat_en;
    uchar ctl_dst_stat_en;
    uchar cfg_dst_per;
    uchar cfg_src_per;
    uchar cfg_src_hs_pol;
    uchar cfg_dst_hs_pol;
    uchar cfg_hs_sel_src;
    uchar cfg_hs_sel_dst;
