...
const uchar get_select_aclk[] =
    {
        [SYSCTL_SOURCE_IN0] = 0,
        [SYSCTL_SOURCE_PLL0] = 1,
};

const uchar get_source_aclk[] =
    {
        [0] = SYSCTL_SOURCE_IN0,
        [1] = SYSCTL_SOURCE_PLL0,
};
...
static int sysctl_clock_bus_en(sysctl_clock_t clock, uchar en)
{
    /*
...
static int sysctl_clock_device_en(sysctl_clock_t clock, uchar en)
{
    switch(clock)
    {
        /*
