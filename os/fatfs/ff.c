...
)
{
	...
	fno->adate = ld_word(dp->dir + DIR_LstAccDate);
	fno->ctime = ld_word(dp->dir + DIR_CrtTime + 0);	/* Time */
	fno->cdate = ld_word(dp->dir + DIR_CrtTime + 2);	/* Date */
	unsigned char *cp = dp->dir + DIR_CrtTime10;
	fno->csec =  *cp;
...
)
{
...
#endif	/* FF_FS_EXFAT */
    {
		...
		// TODO: WARNING 由于评测机sd卡有问题会导致误判为fat16，这里强制置为fat32
		fmt = FS_FAT32;
